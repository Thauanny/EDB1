...
int main(int argc, char *argv[]){
	...
	auto start = std::chrono::steady_clock::now();//comeco do temporizador
	...
	auto end = std::chrono::steady_clock::now();//final do temporizador
	std::chrono::duration<double> tempo_final = end - start;//armezena o tempo de execusao
	std::cout<<"Tempo final: "<<tempo_final.count() << "s\n";//mostra o resultado do tempo de execusao
